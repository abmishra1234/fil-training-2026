...
class AccountService:
    ...
    # TODO Ext6 Task 5: accept owner_id and store it on the Account
    def create_account(self, owner_name: str) -> Account:
        return self.repo.create(Account(owner_name=owner_name, balance=0.0))

    def get_account(self, account_id: int) -> Optional[Account]:
        return self.repo.get_by_id(account_id)

    # TODO Ext6 Task 5/6: accept owner_id (None = all accounts, for admins)
